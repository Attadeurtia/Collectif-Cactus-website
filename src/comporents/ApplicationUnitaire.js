...
export default function ApplicationUnitaire() {
    ...
    const [application] = useState([
        { id: 1, nom: "Netflux", description: "Notre sélection de film, musique et série, à découvrir ou faire découvrir.", logo: "https://static-00.iconduck.com/assets.00/jellyfin-icon-512x512-jcuy5qbi.png", icon_description: "logo de jellyfin", url: "https://cactuserveur.duckdns.org/jellyfin" },
        { id: 2, nom: "Filebrowser", description: "Un stockage de documents, gratuit, illimité et sécurisé.", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Nextcloud_Logo.svg/2560px-Nextcloud_Logo.svg.png", icon_description: "logo de Nextloud", url: "https://cactuserveur.duckdns.org/filebrowser" },
